...
/*
#define BLYNK_TEMPLATE_ID "TMPLFvQZnJ1O"
#define BLYNK_DEVICE_NAME "EE445L Lab 4"
#define BLYNK_AUTH_TOKEN "TWSE36mmRGi3F_pnOQvDE0Blga6Nx7H0"
*/

/*
#define BLYNK_TEMPLATE_ID "TMPL1FqI-jRD"
#define BLYNK_DEVICE_NAME "Lab10"
#define BLYNK_AUTH_TOKEN "y3h26dKzIjVWeveTaVZaf5q9XPF-VnOw";
*/
...
char    pass[256]  = "0335803293960677";
...
# endif
      ...
      else if ((Pin_Number == 555)) {
        // requesting time
        timeClient.update();
        Serial.print("555");         
        Serial.print(",");                
        Serial.printf("%d", timeClient.getHours());        
        Serial.print(",");                
        Serial.printf("%d", timeClient.getMinutes());          
        Serial.print("\n");
      }
      else {
